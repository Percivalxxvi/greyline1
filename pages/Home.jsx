    ...
    <div>
      ...
      <div className="h-100 lg:h-130 lg:w-full flex flex-col lg:flex-row justify-start items-center bg-blue-500 bg-linear-to-r from-gray-800 to-purple-500">
        <div className="flex flex-col lg:items-center lg:justify-center lg:h-100 lg:ml-20 lg:mr-20 p-5 rounded-lg">
          <h1 className="lg:text-6xl text-3xl font-bold text-white lg:text-left text-center lg:w-180">
        ...
        <div className="lg:w-130 lg:h-4/4 w-[95%] h-4/4 duration-500 flex lg:flex hover:shadow-6xl cursor-pointer lg:hover:mr-5 items-center justify-center">
          <img
            className="lg:w-lg lg:h-[98%] w-4/4 h-4/4 lg:hover:mr-3 lg:hover:mb-3 duration-500 object-cover rounded-3xl"
            src={profile1}
            alt=""
          />
        </div>
      ...
      <section
        id="about"
        className="flex flex-col max-w-8xl px-6 py-16 bg-linear-to-r from-gray-800 to-purple-500 justify-center items-center"
      >
